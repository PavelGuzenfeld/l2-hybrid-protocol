...
public:
    ...
    [[nodiscard]] auto has_vlan() const noexcept -> bool { return has_vlan_tag_; }
    ...
    // raw access
    [[nodiscard]] auto raw_data() const noexcept -> std::span<std::uint8_t const> { return data_; }
...
[[nodiscard]] auto build_simple_frame(
