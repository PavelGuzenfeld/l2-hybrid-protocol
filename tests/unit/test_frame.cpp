...
TEST_SUITE("build_simple_frame")
{
    ...
    {
        auto result = l2net::build_simple_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), 0x88B5, "test payload");
        REQUIRE(result.has_value());
    ...
    TEST_CASE("binary payload")
    {
        ...
        auto result = l2net::build_simple_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), 0x0800, payload);
        REQUIRE(result.has_value());
        l2net::frame_parser parser{*result};
