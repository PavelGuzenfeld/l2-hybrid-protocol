...
TEST_SUITE("vlan_tci")
{
    ...
    {
        l2net::vlan_tci const original{.priority = 7, .dei = true, .vlan_id = 100};
...
TEST_SUITE("vlan_frame_builder")
{
    ...
    {
        auto builder = l2net::vlan_frame_builder{}.set_vlan_id(5000); // invalid
    ...
    {
        auto builder = l2net::vlan_frame_builder{}.set_priority(10); // invalid
    ...
    {
        auto builder = l2net::vlan_frame_builder{}.set_vlan_id(100).set_priority(7).set_payload("lots of data here");
...
TEST_SUITE("vlan convenience functions")
{
    TEST_CASE("build_vlan_frame string payload")
    {
        ...
        auto result = l2net::build_vlan_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), tci, 0x88B5,
                                              "test message");
    ...
    TEST_CASE("build_vlan_frame binary payload")
    {
        ...
        auto result =
            l2net::build_vlan_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), tci, 0x0800, payload);
    ...
    TEST_CASE("strip_vlan_tag from tagged frame")
    {
        ...
        auto tagged = l2net::build_vlan_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), tci, 0x0800,
                                              "payload");
    ...
    {
        auto untagged =
            l2net::build_simple_frame(l2net::mac_address::broadcast(), l2net::mac_address::null(), 0x0800, "test");
